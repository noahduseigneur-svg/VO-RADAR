/**
 * Script pour seeder les annonces motos en prod.
 * Lance: node scripts/seed-motos.mjs
 */
import { runScrapers } from "../src/lib/scrapers/index.ts";
...
process.env.SCRAPERS_ENABLED = "leboncoin-moto,lacentrale-moto,autoscout24-moto";
